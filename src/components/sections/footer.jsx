        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-2 col-sm-6 col-md-4">
              <div className="footer-widget">
                <h4>Office</h4>
                <span>123 Business St, New York, NY 10001, USA</span>
                <Link className="ft-mail" to="/mailto:info@company.com">info@company.com</Link>
          ...
          <div className="row">
            <div className="col-xl-4 col-lg-5">
              <div className="cpr-left">
                <p>Copyright© 2025 AI Solutions. All rights reserved.</p>
              </div>
            </div>
